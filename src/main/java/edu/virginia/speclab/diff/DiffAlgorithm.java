 ...
 * I have refactored the original port to java to make this into a reusable 
 * library class that outputs a results object, rather than printing to the console. Tokenization
 * concerns have been separated into an optional <code>DocumentModel</code> object, so that repeated difference
